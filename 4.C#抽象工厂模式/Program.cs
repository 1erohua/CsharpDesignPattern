...
//抽象工厂可以看作是工厂方法模式的拓展
//你可以这样理解
//工厂方法模式制造 不同品牌的、但种类相同的产品。比如华为手机、苹果手机、小米手机
//抽象工厂模式则是 按照 品牌来设置工厂，工厂生产不同种类的产品。比如华为工厂制造耳机手机，苹果工厂也制造耳机手机
//你也可以说工厂方法是抽象工厂的特例，即只造一种产品，当然这样是不准确的
namespace _4.C_抽象工厂模式
{
    //前提：一个工厂制造多个产品
    //代码布局如下：多个抽象产品——不同品牌的具体产品——抽象工厂——品牌工厂
